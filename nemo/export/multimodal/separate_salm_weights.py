...
def get_precision_from_checkpoint(state_dict):
    # Iterate over the parameters to find the dtype
    cnt = 0
    dtype = None
    ...
    if (param is not None):
        ...
        raise ValueError("No parameters found in the checkpoint.")
...
def separate_speechllm_model(model_file_path, output_dir, map_location="cuda:0"):
    ...
    #Saving config file for all components
    ...
    if llm_model_weights:
        ...
        print(f"LLM dtype: {conf.llm_dtype}")
